...
function (exports) {
    ...
    Intence.prototype._loadImages = function() {
        var me = this;
        var sideInitialized = {};
        var defaultUrl = this._elem.getAttribute('intenceimg')||'';
        var img, dir, url;
     ...
     */
    Intence.prototype._getOrigCoord = function(dir, beyond, size, keep) {
     ...
     * infinitely scrollable with intenceInfinite.. attributes
     * 
     * @returns {Object}
     */
    ...
    /**
     * Runs through all Intences, destroys those with elements which
     * do not have intence class anymore
     */
     ...
     * Intence instance for those which do not have one
     */
