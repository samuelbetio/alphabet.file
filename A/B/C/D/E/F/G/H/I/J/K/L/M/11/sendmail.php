...
// email
define('TO_EMAIL', 'yourmail@gmail.com'); 
define('FROM_EMAIL', 'yourmail@gmail.com');  
 ...
 * email: %email%   
 */ 
define( 'BODY', '%message%<br /><br /><small>email from %name%, email: %email%.</small>' );
define( 'SUBJECT', 'Stop Smoking Message from %name%' );

// here the redirect, when the form is submitted
define( 'ERROR_URL', 'contact_error.html' );
define( 'SUCCESS_URL', 'contact_success.html' ); 
define( 'NOTSENT_URL', 'contact_notsent.html' );           
...
// 	    die;
		...
		$headers .= 'From: '.FROM_NAME.' <'.FROM_EMAIL.'>' . "\r\n" . 'Reply-To: ' . $post_data['yiw_contact[email]'];
